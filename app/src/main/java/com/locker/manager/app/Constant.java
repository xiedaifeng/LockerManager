...
public interface Constant {
    ...
    public static final int UserDeliverCode = 0x110;
    ...
    public static final String OpenBoxStateKey ="openBoxState";
    public static final String OpenBoxContentKey ="openBoxState";
